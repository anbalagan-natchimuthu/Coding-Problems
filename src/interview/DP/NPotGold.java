...
/**
 * https://www.youtube.com/watch?v=WxpIHvsu1RI N pots, each with some number of gold coins, are arranged  in a line. You
 * are playing a game against another player. You take turns picking a pot of gold. You may pick a pot from either end
 * of the line, remove the pot, and keep the gold pieces. The player with the most gold at the end wins. Develop a
 * strategy for playing this game.
 *
 * http://www.glassdoor.com/Interview/N-pots-each-with-some-number-of-gold-coins-are-arranged-in-a-line-You-are
 * -playing-a-game-against-another-player-You-tak-QTN_350584.htm
 */
  ...
  public Pair[][] findMoves(int pots[]) {
    ...
    for (int l = 2; l <= pots.length; l++) {
      ...
      for (int i = 0; i <= pots.length - l; i++) {
        // End Index
        int j = i + l - 1;
        // Pick item at left end or right End
