...
public class LongestCommonSubsequence {
    ...
    /** PROBLEM 3: Given two strings how many minimum edits(update, delete or add) is needed to convert one string to another
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Minimum operations (add, delete, update):" + lcs.minimumEdits("azced".toCharArray(), "abcdef".toCharArray()));
    }
}
