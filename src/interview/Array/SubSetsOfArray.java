...
public class SubSetsOfArray {
    ...
    private int subSetsNonDP(int[] inputArray, int total, int i) {
        if (total == 0) {
            ...
            return subSetsNonDP(inputArray, total - inputArray[i], i - 1) +
                subSetsNonDP(inputArray, total, i - 1);
        }
    }
     ...
     */
    private static int subArrayEqualsToSum(int[] arr, int sum) {
        int curr_sum = 0, start =0, i, n = arr.length;
