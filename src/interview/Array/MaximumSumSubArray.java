...
public class MaximumSumSubArray {
  ...
  /**
   * Fun time - Breaking the code 1. NULL array, passing size as zero. 2. Array with all negative numbers. 3. Array
   * with
   * all positive numbers. 4. Array with all zeroes or something like {-5, 4, 0, 0, -3}. Zero should be part of
   * largest
   * sub array indices or not. Similarly for something like {30, -40,-50, 10, 20}, which one should be returned.
   * Above
   * code ignores 0 and always returns the first largest sub array in case of ambiguity. 5. Have a case where a
   * negative
   * numbers are part of return value. {-100, 2, 10, -10, 100}. 6. Have an array with all negative numbers and first
   * element is minimum, {-2, -10, -3, -4, -5}.
   */
