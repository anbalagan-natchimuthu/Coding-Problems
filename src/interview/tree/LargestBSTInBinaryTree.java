...
public class LargestBSTInBinaryTree {
    ...
    public static void main(String args[]){
        ...
        LargestBSTInBinaryTree.ConstructTreeFromInOrderPreOrder ctf = lbi.new ConstructTreeFromInOrderPreOrder();
...
class MinMax {
    ...
    class ConstructTreeFromInOrderPreOrder {
        ...
        private Node createTree(int inorder[],int preorder[], int start, int end){
            ...
            index++;
            node.setLeft(createTree(inorder,preorder,start,i-1));
            node.setRight(createTree(inorder,preorder,i+1,end));
            return node;
        }
    }
